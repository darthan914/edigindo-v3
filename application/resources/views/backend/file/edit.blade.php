...
@section('content')
	...
	<h1>Edit File</h1>
	<div class="x_panel">
	<form class="form-horizontal form-label-left" action="{{ route('backend.file.update', ['id' => $index->id]) }}" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				...
				@if($index->type == 'IMAGE')
				<img src="{{ asset($index->file) }}" style="width: 100px;" alt="{{$index->file}}">
				@endif
				<ul class="parsley-errors-list filled">
