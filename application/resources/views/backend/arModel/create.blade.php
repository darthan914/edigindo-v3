...
@section('content')
	...
	<h1>Create AR Model</h1>
	<div class="x_panel">
	<form class="form-horizontal form-label-left" action="{{ route('backend.arModel.store') }}" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="name_game_object" name="name_game_object" class="form-control {{$errors->first('name_game_object') != '' ? 'parsley-error' : ''}}" value="{{ old('name_game_object', 'ObjectController') }}">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<label class="checkbox-inline"><input type="checkbox" name="active" value="1" @if(old('active')) checked @endif>Active</label>
				<ul class="parsley-errors-list filled">
