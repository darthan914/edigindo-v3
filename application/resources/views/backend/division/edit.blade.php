...
@section('content')
	...
	<h1>Edit Division</h1>
	<div class="x_panel">
	<form class="form-horizontal form-label-left" action="{{ route('backend.division.update', ['id' => $index->id]) }}" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<label class="checkbox-inline"><input type="checkbox" value="1" name="client_available" @if(old('client_available', $index->client_available) == "1") checked @endif>Client Available</label>
				<ul class="parsley-errors-list filled">
