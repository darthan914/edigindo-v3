...
<script type="text/javascript">
	...
	$(function() {
	 ...
	 //    });
		...
		$("input[name=autosearch_address]").geocomplete("find", $("input[name=latitude]").val() + ", " + $("input[name=longitude]").val());
...
@section('content')
	...
	<h1>Edit Delivery</h1>
	<div class="x_panel">
	<form class="form-horizontal form-label-left" action="{{ route('backend.delivery.update', [ 'id' => $index->id ]) }}" method="post" enctype="multipart/form-data">
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						...
						<input type="text" id="spk" name="spk" class="form-control {{$errors->first('spk') != '' ? 'parsley-error' : ''}}" value="{{ old('spk', $index->spk) }}">
				...
				<div class="form-group">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						<input type="datetime-local" id="datetime_send" name="datetime_send" class="form-control {{$errors->first('datetime_send') != '' ? 'parsley-error' : ''}}" value="{{ old('datetime_send', date('Y-m-d\TH:i', strtotime($index->datetime_send)) ) }}">
						<ul class="parsley-errors-list filled">
				...
				<div class="form-group">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						<input type="text" id="get_from" name="get_from" class="form-control {{$errors->first('get_from') != '' ? 'parsley-error' : ''}}" value="{{ old('get_from', $index->get_from) }}">
						<ul class="parsley-errors-list filled">
				...
				<div class="form-group">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						<label class="radio-inline"><input type="radio" name="via" value="Supir" @if(old('via', $index->via) == "Supir") checked @endif>Supir</label>
						<label class="radio-inline"><input type="radio" name="via" value="Kurir" @if(old('via', $index->via) == "Kurir") checked @endif>Kurir</label>
			...
			<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							...
							<textarea id="address" name="address" class="form-control {{$errors->first('address') != '' ? 'parsley-error' : ''}}" >{{ old('address', $index->address) }}</textarea>
							<ul class="parsley-errors-list filled">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							<select id="city" name="city" class="form-control {{$errors->first('city') != '' ? 'parsley-error' : ''}}">
								...
								@foreach ($city as $list)
									<option value="{{ $list }}" @if(old('city', $index->city) == $list) selected @endif>{{ $list }}</option>
								@endforeach
							</select>
							<ul class="parsley-errors-list filled">
					...
					<div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							...
							<input type="text" id="pic_name" name="pic_name" class="form-control {{$errors->first('pic_name') != '' ? 'parsley-error' : ''}}" value="{{ old('pic_name', $index->pic_name) }}">
							<ul class="parsley-errors-list filled">
					...
					<div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							<input type="text" id="pic_phone" name="pic_phone" class="form-control {{$errors->first('pic_phone') != '' ? 'parsley-error' : ''}}" value="{{ old('pic_phone', $index->pic_phone) }}">
							<ul class="parsley-errors-list filled">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="form-group">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						<label class="checkbox-inline"><input type="checkbox" value="10" name="ppn" @if(old('ppn', $index->ppn) == "10") checked @endif>PPn 10%</label>
						<ul class="parsley-errors-list filled">
				...
				<div class="form-group">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<textarea id="detail" name="detail" class="form-control {{$errors->first('detail') != '' ? 'parsley-error' : ''}}">{{ old('detail', $index->detail) }}</textarea
						>
						<ul class="parsley-errors-list filled">
				...
				<div class="form-group">
					<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
						{{ csrf_field() }}
						<input type="hidden" id="latitude" name="latitude" data-geo="lat" value="{{ old('latitude', $index->latitude) }}">
						<input type="hidden" id="longitude" name="longitude" data-geo="lng" value="{{ old('longitude', $index->longitude) }}">
