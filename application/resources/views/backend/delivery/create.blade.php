	...
	$(function() {
	 ...
	 //    });
		...
		$("input[name=autosearch_address]").geocomplete({
			...
			// 			// $("input[name=autosearch_address]").val(result[1].formatted_address);
			// 		} else {
...
@section('content')
	...
	<div class="x_panel">
	<form class="form-horizontal form-label-left" action="{{ route('backend.delivery.store') }}" method="post" enctype="multipart/form-data">
		<div class="row">
			<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							<input type="datetime-local" id="datetime_send" name="datetime_send" class="form-control {{$errors->first('datetime_send') != '' ? 'parsley-error' : ''}}" value="{{ old('datetime_send') }}">
							<ul class="parsley-errors-list filled">
