...
@section('content')
	...
	<div class="x_panel">
	<form class="form-horizontal form-label-left" action="{{ route('backend.supplier.store') }}" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="bank" name="bank" class="form-control {{$errors->first('bank') != '' ? 'parsley-error' : ''}}" value="{{ old('bank') }}">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="no_rekening" name="no_rekening" class="form-control {{$errors->first('no_rekening') != '' ? 'parsley-error' : ''}}" value="{{ old('no_rekening') }}">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="name_rekening" name="name_rekening" class="form-control {{$errors->first('name_rekening') != '' ? 'parsley-error' : ''}}" value="{{ old('name_rekening') }}">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="cp" name="cp" class="form-control {{$errors->first('cp') != '' ? 'parsley-error' : ''}}" value="{{ old('cp') }}">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="phone_home" name="phone_home" class="form-control {{$errors->first('phone_home') != '' ? 'parsley-error' : ''}}" value="{{ old('phone_home') }}">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="phone_mobile" name="phone_mobile" class="form-control {{$errors->first('phone_mobile') != '' ? 'parsley-error' : ''}}" value="{{ old('phone_mobile') }}">
				<ul class="parsley-errors-list filled">
