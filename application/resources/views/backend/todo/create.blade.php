...
<script type="text/javascript">
	$(function() {
		...
		$('input[name="date"]').on('apply.daterangepicker', function(ev, picker) {
	        $(this).val(picker.startDate.format('DD MMMM YYYY HH:ss'));
	    });
...
@section('content')
	...
	<h1>Create To Do</h1>
	<div class="x_panel">
	<form class="form-horizontal form-label-left" action="{{ route('backend.todo.store') }}" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				...
				<input type="text" id="brand" name="brand" class="form-control {{$errors->first('brand') != '' ? 'parsley-error' : ''}}" value="{{ old('brand') }}">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="event" name="event" class="form-control {{$errors->first('event') != '' ? 'parsley-error' : ''}}" value="{{ old('event') }}">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="date_todo" name="date_todo" class="form-control {{$errors->first('date_todo') != '' ? 'parsley-error' : ''}}" value="{{ old('date_todo') }}">
				<ul class="parsley-errors-list filled">
