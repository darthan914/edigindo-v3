...
@section('content')
	...
	<h1>Create Car</h1>
	<div class="x_panel">
	<form class="form-horizontal form-label-left" action="{{ route('backend.car.store') }}" method="post" enctype="multipart/form-data">
		<div class="form-group">
			<label for="num_car" class="control-label col-md-3 col-sm-3 col-xs-12">Name Car <span class="required">*</span>
			</label>
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="num_car" name="num_car" class="form-control {{$errors->first('num_car') != '' ? 'parsley-error' : ''}}" value="{{ old('num_car') }}">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="stnk" name="stnk" class="form-control {{$errors->first('stnk') != '' ? 'parsley-error' : ''}}" value="{{ old('stnk') }}">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="kir1" name="kir1" class="form-control {{$errors->first('kir1') != '' ? 'parsley-error' : ''}}" value="{{ old('kir1') }}">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="kir2" name="kir2" class="form-control {{$errors->first('kir2') != '' ? 'parsley-error' : ''}}" value="{{ old('kir2') }}">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="gps" name="gps" class="form-control {{$errors->first('gps') != '' ? 'parsley-error' : ''}}" value="{{ old('gps') }}">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="insurance" name="insurance" class="form-control {{$errors->first('insurance') != '' ? 'parsley-error' : ''}}" value="{{ old('insurance') }}">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="date_km" name="date_km" class="form-control {{$errors->first('date_km') != '' ? 'parsley-error' : ''}}" value="{{ old('date_km') }}">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="weekly_km" name="weekly_km" class="form-control {{$errors->first('weekly_km') != '' ? 'parsley-error' : ''}}" value="{{ old('weekly_km') }}">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="paper_km" name="paper_km" class="form-control {{$errors->first('paper_km') != '' ? 'parsley-error' : ''}}" value="{{ old('paper_km') }}">
				<ul class="parsley-errors-list filled">
