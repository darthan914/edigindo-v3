...
@section('content')
			...
			<div class="modal-content">
				<form class="form-horizontal form-label-left" action="{{ route('backend.pr.storeDetail') }}" method="post" enctype="multipart/form-data">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="purchasing_id" class="control-label col-md-3 col-sm-3 col-xs-12">Purchasing <span class="required">*</span>
							</label>
							<div class="col-md-9 col-sm-9 col-xs-12">
			...
			<div class="modal-content">
				<form class="form-horizontal form-label-left" action="{{ route('backend.pr.updateDetail') }}" method="post" enctype="multipart/form-data">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="purchasing_id-edit" class="control-label col-md-3 col-sm-3 col-xs-12">Purchasing <span class="required">*</span>
							</label>
							<div class="col-md-9 col-sm-9 col-xs-12">
	...
	<div class="x_panel">
		...
		<div class="x_content">
			...
			<form class="form-horizontal form-label-left" action="{{ route('backend.beta.back') }}" method="post" enctype="multipart/form-data">
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						...
						<input type="text" id="no_pr" name="no_pr" class="form-control {{$errors->first('no_pr') != '' ? 'parsley-error' : ''}}" value="{{ old('no_pr') }}" readonly>
						<ul class="parsley-errors-list filled">
